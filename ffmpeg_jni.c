...
jint Java_com_liandisys_dpjk_monitor_PlayActivity_InitStream(JNIEnv* env,
...
jint Java_com_liandisys_dpjk_monitor_PlayActivity_getFrameHeight(JNIEnv * env, jobject this){
	return ff_play_getvideo_height();
}

jint Java_com_liandisys_dpjk_monitor_PlayActivity_getFrameWidth(JNIEnv * env, jobject this){
	return ff_play_getvideo_width();
}

/*free all resource*/
jint Java_com_liandisys_dpjk_monitor_PlayActivity_frameFree(JNIEnv * env, jobject this){
	return ff_play_FreeAll();
}

/*TODO 根据流的内容绘图*/
void Java_com_liandisys_dpjk_monitor_PlayActivity_drawFrame(JNIEnv * env, jobject this,
		jstring bitmap) {
...
jint Java_com_liandisys_dpjk_monitor_FFAudio_getAudioSamplerate(void) {
	 return ff_play_getaudio_samplerate();
}

jint Java_com_liandisys_dpjk_monitor_FFAudio_getAudioBuf(JNIEnv * env, jobject this,jbyteArray jAudioBuf) {
	int ret;
	int len_get = 0;
	int data_size=0;
